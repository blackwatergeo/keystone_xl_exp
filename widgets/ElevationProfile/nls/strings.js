define({
  root: ({
    descriptionlabel: "Use the Measure tool to draw a line on the map that you want to see the elevation profile for.  Widget for Display purposes only and not to scale.",
    ...
    display: {
      ...
      hoverOver: "Hover over or touch the Elevations Profile chart to display elevations and show location on map.  Widget for Display purposes only and not to scale."
    },
    chart: {
